...
while {true} do {
    _text = format ["Commander: %1, recruits: %2, guerilla money: %3", ["commanderName"] call fn_getGlobalValue,
    ["recruitCount"] call fn_getGlobalValue, ["money"] call fn_getGlobalValue];
