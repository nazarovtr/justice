...
class RscControlsGroupNoScrollbars : RscControlsGroupT {
...
class RscButtonMenuT:RscShortcutButtonT {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class TAW_VDMenu {
	...
	class controlsBackground {
		class TitleBackground : RscTextT {
		...
		class ButtonClose : RscButtonMenuT {
			idc = -1;
			text = "Close";
	...
	class controls {
		...
		//Values (RscEditT Butons)
		class VD_onFoot_Edit : RscEditT {
			idc = INFANTRY_EDIT;
			text = "";
		...
		class ObjectSyncCheckbox : RscCheckBoxT
		{
			idc = 2931;
			x = .32; y = .6;
		...
		class Manager:RscControlsGroupT {
			idc = MANAGER_GROUP;
			...
			class Controls {
				class SaveLoadGroup:RscControlsGroupNoScrollbars {
					...
					class Controls {
						class MyTitleBackground:RscTextT {
							colorBackground[] = { "(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", "(profilenamespace getvariable ['GUI_BCG_RGB_A',0.7])" };
							idc = -1;
							x = 0;
							y = 0;
						...
						class SaveButton:RscButtonMenuT {
							text = "Save";
						...
						class HideButton:RscButtonMenuT {
							text = "Hide";
